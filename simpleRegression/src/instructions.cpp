...
void fillInstructionSet(Instructions::Set& set) {
	...
	auto minusC = [](double a, double b, Data::Constant c, Data::Constant d, Data::Constant e) -> double { return a*(double)c - b*(double)d + (double)e; };
	auto addC = [](double a, double b, Data::Constant c, Data::Constant d, Data::Constant e) -> double { return a*(double)c + b*(double)d + (double)e; };
	auto multC = [](double a, double b, Data::Constant c,  Data::Constant d) -> double { return a * b*(double)c + (double)d; };
	auto sinC = [](double a, Data::Constant c, Data::Constant d) -> double { return std::sin(a*(double)c + (double(d))); };
	set.add(*(new Instructions::LambdaInstruction<double, double, Data::Constant, Data::Constant, Data::Constant>(minusC, "$0 = $1 - $2;")));
	set.add(*(new Instructions::LambdaInstruction<double, double, Data::Constant, Data::Constant, Data::Constant>(addC, "$0 = $1 + $2;")));
	set.add(*(new Instructions::LambdaInstruction<double, double, Data::Constant, Data::Constant>(multC, "$0 = $1 * $2;")));
	set.add(*(new Instructions::LambdaInstruction<double, Data::Constant, Data::Constant>(sinC, "$0 = sin($1);")));
	...
	auto instr1 = [](
		double a1,
		Data::Constant w1, Data::Constant w2
		) -> double { 
			return std::max(0.0, a1*(double)w1 + (double)w2); 
			};

	auto instr2 = [](
		double a1, double a2, double a3, double a4, double a5, double a6, double a7, double a8,  
		Data::Constant w1, Data::Constant w2, Data::Constant w3, Data::Constant w4,
		Data::Constant w5, Data::Constant w6, Data::Constant w7, Data::Constant w8, Data::Constant w9
		) -> double { 
			return std::max(0.0, a1*(double)w1 + a2*(double)w2 + a3*(double)w3 + a4*(double)w4 + 
				   			a5*(double)w5 + a6*(double)w6 + a7*(double)w7 + a8*(double)w8 + (double)w9); 
			};
	...
	auto instr3 = [](
		...
		Data::Constant w1, Data::Constant w2
			...
			return std::tanh(a1*(double)w1 + (double)w2); 
			};

	/*set.add(*(new Instructions::LambdaInstruction<double, Data::Constant, Data::Constant>(instr1)));
	set.add(*(new Instructions::LambdaInstruction<
		double, double, double, double, double, double, double, double, 
		Data::Constant, Data::Constant, Data::Constant, Data::Constant,
		Data::Constant, Data::Constant, Data::Constant, Data::Constant, Data::Constant>(instr2)));
	set.add(*(new Instructions::LambdaInstruction<double, Data::Constant, Data::Constant>(instr3)));*/
}
